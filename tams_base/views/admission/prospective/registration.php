...
<div class="span12">
    <div class="box box-bordered box-color">
        ...
        <div class="box-content">
            <form novalidate="novalidate" action="<?php echo site_url('admission/register')?>" method="POST" class="form-horizontal form-wizard ui-formwizard" id="ss">
                <div style="display: none;" class="step ui-formwizard-content" id="firstStep">
                    ...
                    <div class="step-forms">
                        <div class="box-title">
                            <h4><i class="icon-list"></i> Personal Information</h4>
                        </div>
