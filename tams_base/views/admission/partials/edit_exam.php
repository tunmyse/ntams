    ...
    <form 
        ...
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="exam_name" id="edit_exam_name" class="input-xlarge" >
                </div>
            </div>
            <div class="control-group">
                <label for="exam_sname" class="control-label">Short Name:</label>
                <div class="controls">
                    <input type="text" name="exam_sname" id="edit_exam_sname" class="input-xlarge" >
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-xlarge">
                        <select name="exam_group" id="edit_exam_group" class='chosen-select'>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input value="1" type="text" min="1" max="20" name="exam_valid" id="edit_exam_valid" class="spinner input-mini uneditable-input"/>
                </div>
            </div>
            <div class="control-group">
                <label for="exam_min" class="control-label">Minimum Subjects Required:</label>
                <div class="controls">
                    <input value="1" type="text" min="1" max="20" name="exam_min" id="edit_exam_min" class="spinner input-mini uneditable-input"/>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-xlarge">
                        <select name="exam_score" id="edit_exam_score" class='chosen-select'>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-xlarge">
                        <select name="exam_status" id="edit_exam_status" class='chosen-select'>
