...
<div 
    ...
    aria-hidden="true">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add Installment Payment </h4>
        </div>
    <form name="form1" class="form-horizontal form-striped" method="post" action="<?php echo base_url('bursary/setup/sets/instalment')?>">
