<div class="row-fluid">
        <div class="span12">
                <div class="box box-bordered box-color">
                        <div class="box-title">
                                <h3><i class="glyphicon-credit_card"></i><i class="icon-remove-sign"></i> Transaction Decline</h3>
                        </div>
                                ...
                                <div class="form-horizontal form-bordered">
                                    ...
                                    <p style="text-align: center; font-size: 16px" class="alert alert-success">
                                        <i style="font-size: 20px" class="glyphicon-warning_sign"></i>
                                              Kindly note your Transaction Reference Number (TRN) as it will be used to track dispute.
