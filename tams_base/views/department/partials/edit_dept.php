...
<div 
    ...
    <form 
        ...
        method="post" 
        action="<?php echo site_url('department/create')?>">
        ...
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="dept_name" id="edit_dept_name" class="input-xlarge" >
                </div>
            </div>
            <div class="control-group">
                <label for="dept_code" class="control-label">Department Code:</label>
                <div class="controls">
                    <input type="text" name="dept_code" id="edit_dept_code" class="input-xlarge" >
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-xlarge">
                        <select name="dept_col" id="edit_dept_col" class='chosen-select'>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="dept_remark" id="edit_dept_remark" class="input-xlarge" >
                </div>
            </div>
        </div>
