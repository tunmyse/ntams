...
<div class="modal hide fade" id="create_dept_modal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    ...
    <form id="create_dept_form" class="form-horizontal form-striped" method="post" action="<?php echo site_url('department/create')?>">
