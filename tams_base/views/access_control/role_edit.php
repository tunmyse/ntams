<div>
    ...
    <a data-toggle="modal" href="#edit_role_modal">edit name</a>
                
    <p>
        <?php echo $info->description?> 
        <a data-toggle="modal" href="#edit_role_modal"><?php echo $info->description != NULL? 'edit':'add'?> description</a> 
    </p>
            ...
            <div class="tab-content">
                <div id="groups" class="tab-pane active">
                    <p class="clearfix pad-1">
                        <a class="btn btn-green pull-right" data-toggle="modal" href="#add_group_modal">
                            Add Group(s)
                        </a>
                    </p>
