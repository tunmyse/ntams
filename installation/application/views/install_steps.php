                        ...
                        <form action="<?php echo site_url('verify_steps')?>" method="POST" class='form-horizontal form-wizard' id="setup_form">
                            ...
                            <div class="step" id="secondStep">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="sch[phone]" id="sclphn" class="input-xlarge" data-rule-required="true">
                                    </div>
                                </div>
                                <div class="control-group">
                            ...
                            <div class="step" id="thirdStep">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="db[server]" id="dbname" class="input-xlarge" value="localhost" data-rule-required="true">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="db[driver]" id="driver" value="mysqli" class="input-xlarge" data-rule-required="true">
                                    </div>
                                </div>
                            </div>
